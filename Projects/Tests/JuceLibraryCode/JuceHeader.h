...
#ifndef __APPHEADERFILE_ENYWBM__
#define __APPHEADERFILE_ENYWBM__
...
namespace ProjectInfo
{
    ...
    const char* const  versionString  = "1.9.5";
    const int          versionNumber  = 0x10905;
}
#endif

#endif   // __APPHEADERFILE_ENYWBM__
