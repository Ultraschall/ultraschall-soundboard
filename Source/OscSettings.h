...
public:
  OscSettings(PropertiesFile *pf, OscServer *s)
    ...
    oscLogger->setColour(ListBox::ColourIds::backgroundColourId,
                         Colours::black);
    ...
    addAndMakeVisible(receiveHostLabel =
                          new Label("receiveHostLabel", TRANS("Host:\n")));
    ...
    addAndMakeVisible(remoteHostLabel =
                          new Label("sendHostLabel", TRANS("Device:\n")));
