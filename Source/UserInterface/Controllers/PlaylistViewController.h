...
{
public:
	explicit PlaylistViewController(std::shared_ptr<Store> store);

	~PlaylistViewController() override;
...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(PlaylistViewController)
};
