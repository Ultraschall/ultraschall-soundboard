...
void SoundboardAudioProcessorEditor::paint(Graphics& g)
{
    ...
    g.drawText(CharPointer_UTF8("OSC aktivit\xc3\xa4t"), 30, getHeight() - 27, 100, 24, Justification::left);
    ...
    if (oscIndicator) {
        ...
        g.drawText(FA_DOT_CIRCLE_O, 3, getHeight() - 27, 24, 24, Justification::centred, true);
        g.setColour(Colours::grey.brighter());
    }
    g.drawText(FA_CIRCLE_O, 3, getHeight() - 27, 24, 24, Justification::centred, true);
    g.drawText(FA_COG, getWidth() - 50, getHeight() - 27, 24, 24, Justification::centred, true);
}
...
void SoundboardAudioProcessorEditor::refreshTable()
{
    tableListBox->repaint();
}