...
public:
    ...
    void paint(Graphics& g) override
    {
        ColourGradient gradiant(ThemeBackground3, 0.0f, 0.0f,
                                ThemeBackground3, 0.0f, static_cast<float>(getHeight()), false);
        ...
        if (spacer)
        {
            ...
            g.drawHorizontalLine(2, 0.0f, static_cast<float>(getWidth()));
...
public:
    ...
    void paint(Graphics& g) override
    {
        ColourGradient gradiant(ThemeForeground2, 0.0f, 0.0f,
                                ThemeForeground2, 0.0f, static_cast<float>(getHeight()), false);
