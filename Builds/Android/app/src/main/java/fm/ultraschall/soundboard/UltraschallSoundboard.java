...
package fm.ultraschall.soundboard;
...
//==============================================================================
public class UltraschallSoundboard   extends Activity
{
    //==============================================================================
    static
    {
    ...
    public MidiDeviceManager getAndroidMidiDeviceManager()
    {
        ...
        synchronized (UltraschallSoundboard.class)
        {
               ...
               .setOnCancelListener (new DialogInterface.OnCancelListener()
                    {
                        ...
                        {
                            UltraschallSoundboard.this.alertDismissed (callback, 0);
                        }
                    })
               ...
               .setPositiveButton (okButtonText.isEmpty() ? "OK" : okButtonText, new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.dismiss();
                            UltraschallSoundboard.this.alertDismissed (callback, 1);
                        }
                    })
               ...
               .setNegativeButton ("No", new DialogInterface.OnClickListener()
                    {
                        ...
                        {
                            dialog.dismiss();
                            UltraschallSoundboard.this.alertDismissed (callback, 2);
                        }
                    })
