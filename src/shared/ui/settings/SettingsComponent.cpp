    ...
    : processor(p)
{
    ...
    addAndMakeVisible(duckingSlider);
    ...
    addAndMakeVisible(oscBar);
    addAndMakeVisible(oscLabel);
    oscLabel.setText(TRANS("OSC"), dontSendNotification);

    // receiver
    addAndMakeVisible(oscLocalEnabledToggleButton);
    ...
    addAndMakeVisible(oscLocalHostnameTextEditor);
    ...
    addAndMakeVisible(oscLocalPortNumberTextEditor);
    ...
    addAndMakeVisible(oscRemoteEnabledToggleButton);
    ...
    addAndMakeVisible(oscRemoteHostnameTextEditor);
    ...
    addAndMakeVisible(oscRemotePortNumberTextEditor);
    ...
    addAndMakeVisible(oscRepeaterEnabledToggleButton);
    ...
    addAndMakeVisible(oscRepeaterHostnameTextEditor);
    ...
    addAndMakeVisible(oscRepeaterPortNumberTextEditor);
    ...
    addAndMakeVisible(audioBar);
    addAndMakeVisible(audioLabel);
    audioLabel.setText(TRANS("Audio Settings"), dontSendNotification);
    audioDeviceSelectorComponent = std::make_unique<AudioDeviceSelectorComponent>(*deviceManager,
processor.getNumInputChannels(), processor.getNumInputChannels(), processor.getNumOutputChannels(), processor.getNumOutputChannels(), true, false, true, false);
    addAndMakeVisible(audioDeviceSelectorComponent.get())
    #endif
